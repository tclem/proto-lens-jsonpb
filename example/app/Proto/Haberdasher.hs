...
module Proto.Haberdasher (
        ...
        Bill'BillingStatus'UnrecognizedValue, ChangeType(..), ChangeType(),
        ChangeType'UnrecognizedValue, DeletedTerm(), Demo(),
        DiffTreeVertex(), DiffTreeVertex'DiffTerm(..),
        _DiffTreeVertex'Deleted, _DiffTreeVertex'Inserted, EmptyMessage(),
        FieldTestMessage(), Hat(), InsertedTerm(), Ping(), Pong(),
...
instance Data.ProtoLens.Message Bill where
  ...
  packedMessageDescriptor _
    = "\n\
      \\EOTBill\DC20\n\
      \\ENQprice\CAN\SOH \SOH(\v2\SUB.example.haberdasher.PriceR\ENQprice\DC2?\n\
      \\ACKstatus\CAN\STX \SOH(\SO2'.example.haberdasher.Bill.BillingStatusR\ACKstatus\DC2\ESC\n\
...
data Demo
  = Demo'_constructor {_Demo'changeType :: !ChangeType,
...
instance Prelude.Show Demo where
  showsPrec _ __x __s
    = Prelude.showChar
        ...
        (Prelude.showString
           (Data.ProtoLens.showMessageShort __x) (Prelude.showChar '}' __s))
instance Data.ProtoLens.Field.HasField Demo "changeType" ChangeType where
  fieldOf _
    = (Prelude..)
        (Lens.Family2.Unchecked.lens
           _Demo'changeType (\ x__ y__ -> x__ {_Demo'changeType = y__}))
        Prelude.id
instance Data.ProtoLens.Message Demo where
  ...
  packedMessageDescriptor _
    = "\n\
      \\EOTDemo\DC2@\n\
      \\vchange_type\CAN\SOH \SOH(\SO2\US.example.haberdasher.ChangeTypeR\n\
      \changeType"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
  ...
  defMessage
    = Demo'_constructor
        {_Demo'changeType = Data.ProtoLens.fieldDefault,
         _Demo'_unknownFields = []}
  parseMessage
    = let
        loop :: Demo -> Data.ProtoLens.Encoding.Bytes.Parser Demo
        loop x
          = do end <- Data.ProtoLens.Encoding.Bytes.atEnd
               if end then
                   do (let missing = []
      ...
      in
        (Data.ProtoLens.Encoding.Bytes.<?>)
          (do loop Data.ProtoLens.defMessage) "Demo"
  buildMessage
    = \ _x
        -> (Data.Monoid.<>)
             (let
...
instance Data.ProtoLens.Message DiffTreeVertex where
  ...
  packedMessageDescriptor _
    = "\n\
      ...
      \\SOdiff_vertex_id\CAN\SOH \SOH(\ENQR\fdiffVertexId\DC2<\n\
      \\adeleted\CAN\STX \SOH(\v2 .example.haberdasher.DeletedTermH\NULR\adeleted\DC2?\n\
      \\binserted\CAN\ETX \SOH(\v2!.example.haberdasher.InsertedTermH\NULR\binsertedB\v\n\
      \\tdiff_term"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
instance Data.ProtoLens.Message Pong where
  ...
  packedMessageDescriptor _
    = "\n\
      \\EOTPong\DC2\SYN\n\
      \\ACKstatus\CAN\SOH \SOH(\tR\ACKstatus\DC2/\n\
      \\ENQstuff\CAN\STX \ETX(\v2\EM.example.haberdasher.TestR\ENQstuff\DC2\SO\n\
...
instance Data.ProtoLens.Message Test where
  ...
  packedMessageDescriptor _
    = "\n\
      \\EOTTest\DC2\DC4\n\
      \\ENQitems\CAN\SOH \ETX(\ENQR\ENQitems\DC29\n\
      \\n\
      \alt_prices\CAN\STX \ETX(\v2\SUB.example.haberdasher.PriceR\taltPrices"
  packedFileDescriptor _ = packedFileDescriptor
  fieldsByTag
    = let
...
packedFileDescriptor
  = "\n\
    \\DC1haberdasher.proto\DC2\DC3example.haberdasher\"\RS\n\
    \\EOTSize\DC2\SYN\n\
    \\ACKinches\CAN\SOH \SOH(\ENQR\ACKinches\"G\n\
    \\ETXHat\DC2\SYN\n\
    \\ACKinches\CAN\SOH \SOH(\ENQR\ACKinches\DC2\DC4\n\
    \\ENQcolor\CAN\STX \SOH(\tR\ENQcolor\DC2\DC2\n\
    \\EOTname\CAN\ETX \SOH(\tR\EOTname\"\228\SOH\n\
    \\EOTBill\DC20\n\
    \\ENQprice\CAN\SOH \SOH(\v2\SUB.example.haberdasher.PriceR\ENQprice\DC2?\n\
    \\ACKstatus\CAN\STX \SOH(\SO2'.example.haberdasher.Bill.BillingStatusR\ACKstatus\DC2\ESC\n\
    \\bvat_info\CAN\ETX \SOH(\tH\NULR\avatInfo\DC2\ESC\n\
    ...
    \\ENQitems\CAN\SOH \ETX(\ENQR\ENQitems\DC29\n\
    \\n\
    \alt_prices\CAN\STX \ETX(\v2\SUB.example.haberdasher.PriceR\taltPrices\"7\n\
    \\ENQPrice\DC2\CAN\n\
    \\adollars\CAN\SOH \SOH(\rR\adollars\DC2\DC4\n\
    \\ENQcents\CAN\STX \SOH(\rR\ENQcents\" \n\
    \\EOTPing\DC2\CAN\n\
    \\aservice\CAN\SOH \SOH(\tR\aservice\"\156\SOH\n\
    \\EOTPong\DC2\SYN\n\
    \\ACKstatus\CAN\SOH \SOH(\tR\ACKstatus\DC2/\n\
    \\ENQstuff\CAN\STX \ETX(\v2\EM.example.haberdasher.TestR\ENQstuff\DC2\SO\n\
    \\SOHt\CAN\ETX \SOH(\rH\NULR\SOHt\DC2\SO\n\
    ...
    \\n\
    \ChangeType\DC2\t\n\
    \\ENQADDED\DLE\NUL\DC2\v\n\
    \\aREMOVED\DLE\SOH2\141\SOH\n\
    \\vHaberdasher\DC2>\n\
    \\aMakeHat\DC2\EM.example.haberdasher.Size\SUB\CAN.example.haberdasher.Hat\DC2>\n\
    \\aGetBill\DC2\CAN.example.haberdasher.Hat\SUB\EM.example.haberdasher.Bill2G\n\
    \\ACKHealth\DC2=\n\
    \\ENQCheck\DC2\EM.example.haberdasher.Ping\SUB\EM.example.haberdasher.PongB\rZ\vhaberdasherJ\253\DC4\n\
    \\ACK\DC2\EOT\NUL\NULe\SOH\n\
    \\b\n\
    \\SOH\f\DC2\ETX\NUL\NUL\DC2\n\
    \+\n\
    \\SOH\STX\DC2\ETX\EOT\NUL\FS2! This is an example set of types\n\
    \\n\
    \\b\n\
    ...
    \\n\
    \\n\
    \\ETX\EOT\a\SOH\DC2\ETXH\b\f\n\
    \\v\n\
    \\EOT\EOT\a\STX\NUL\DC2\ETXI\STX\GS\n\
    \\f\n\
    \\ENQ\EOT\a\STX\NUL\ACK\DC2\ETXI\STX\f\n\
    \\f\n\
    \\ENQ\EOT\a\STX\NUL\SOH\DC2\ETXI\r\CAN\n\
    \\f\n\
    \\ENQ\EOT\a\STX\NUL\ETX\DC2\ETXI\ESC\FS\n\
    \\n\
    \\n\
    \\STX\ENQ\NUL\DC2\EOTL\NULO\SOH\n\
    \\n\
    \\n\
    \\ETX\ENQ\NUL\SOH\DC2\ETXL\ENQ\SI\n\
    \\v\n\
    \\EOT\ENQ\NUL\STX\NUL\DC2\ETXM\STX\f\n\
    \\f\n\
    \\ENQ\ENQ\NUL\STX\NUL\SOH\DC2\ETXM\STX\a\n\
    \\f\n\
    \\ENQ\ENQ\NUL\STX\NUL\STX\DC2\ETXM\n\
    \\v\n\
    \\v\n\
    \\EOT\ENQ\NUL\STX\SOH\DC2\ETXN\STX\SO\n\
    \\f\n\
    \\ENQ\ENQ\NUL\STX\SOH\SOH\DC2\ETXN\STX\t\n\
    \\f\n\
    \\ENQ\ENQ\NUL\STX\SOH\STX\DC2\ETXN\f\r\n\
    \\n\
    \\n\
    \\STX\EOT\b\DC2\EOTQ\NULS\SOH\n\
    \\n\
    \\n\
    \\ETX\EOT\b\SOH\DC2\ETXQ\b\CAN\n\
    \\v\n\
    \\EOT\EOT\b\STX\NUL\DC2\ETXR\STX\ETB\n\
    \\f\n\
    \\ENQ\EOT\b\STX\NUL\ENQ\DC2\ETXR\STX\a\n\
    \\f\n\
    \\ENQ\EOT\b\STX\NUL\SOH\DC2\ETXR\b\DC2\n\
    \\f\n\
    \\ENQ\EOT\b\STX\NUL\ETX\DC2\ETXR\NAK\SYN\n\
    \\t\n\
    \\STX\EOT\t\DC2\ETXU\NUL\ETB\n\
    \\n\
    \\n\
    \\ETX\EOT\t\SOH\DC2\ETXU\b\DC4\n\
    \\n\
    \\n\
    \\STX\EOT\n\
    \\DC2\EOTW\NUL]\SOH\n\
    ...
    \\v\n\
    \\EOT\EOT\n\
    \\STX\NUL\DC2\ETXX\STX\ESC\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\NUL\ENQ\DC2\ETXX\STX\a\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\NUL\SOH\DC2\ETXX\b\SYN\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\NUL\ETX\DC2\ETXX\EM\SUB\n\
    \\f\n\
    \\EOT\EOT\n\
    \\b\NUL\DC2\EOTY\STX\\\ETX\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\b\NUL\SOH\DC2\ETXY\b\DC1\n\
    \\v\n\
    \\EOT\EOT\n\
    \\STX\SOH\DC2\ETXZ\EOT\FS\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\SOH\ACK\DC2\ETXZ\EOT\SI\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\SOH\SOH\DC2\ETXZ\DLE\ETB\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\SOH\ETX\DC2\ETXZ\SUB\ESC\n\
    \\v\n\
    \\EOT\EOT\n\
    \\STX\STX\DC2\ETX[\EOT\RS\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\STX\ACK\DC2\ETX[\EOT\DLE\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\STX\SOH\DC2\ETX[\DC1\EM\n\
    \\f\n\
    \\ENQ\EOT\n\
    \\STX\STX\ETX\DC2\ETX[\FS\GS\n\
    \\n\
    \\n\
    \\STX\EOT\v\DC2\EOT_\NULa\SOH\n\
    \\n\
    \\n\
    \\ETX\EOT\v\SOH\DC2\ETX_\b\DC3\n\
    \\v\n\
    \\EOT\EOT\v\STX\NUL\DC2\ETX`\STX\DC2\n\
    \\f\n\
    ...
    \\n\
    \\n\
    \\STX\EOT\f\DC2\EOTc\NULe\SOH\n\
    \\n\
    \\n\
    \\ETX\EOT\f\SOH\DC2\ETXc\b\DC4\n\
    \\v\n\
    \\EOT\EOT\f\STX\NUL\DC2\ETXd\STX\DC2\n\
    \\f\n\
    \\ENQ\EOT\f\STX\NUL\ENQ\DC2\ETXd\STX\b\n\
    \\f\n\
    \\ENQ\EOT\f\STX\NUL\SOH\DC2\ETXd\t\r\n\
    \\f\n\
    \\ENQ\EOT\f\STX\NUL\ETX\DC2\ETXd\DLE\DC1b\ACKproto3"